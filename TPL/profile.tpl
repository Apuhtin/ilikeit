    ...
    <div class="FormGroup">
        ...
        <div class="DivAvatar200">
            <div class="DivBrAvatar200" id="msgImgAvatar">
                <img class ="Avatar200" src="{srcAvatar}">
            </div>
        </div>
        ...
        <form id="data1"> 
            ...
            <input type="file" id="ButtonDownload" name="filename" onClick = '$("#MsgTxt").html("")'>
        ...
        <div class="BtnDiv">
            <input type="submit" class="ButtonProfile" value="Удалить" name="DelFile" id="DelFile" onClick = "DelFile()">
        </div>            
            ...
            <div class="FormElements">
                ...
                <div class="ColInput"> 
                    <select name="Lang" id="Lang" class="select" oninput='$("#msgSaveUser").html("")'>
                        <option {LangSlected_0} value="0">Русский</option>
                        <option {LangSlected_1} value="1">Английский</option>
                    </select>  
                </div> 
            </div> 
