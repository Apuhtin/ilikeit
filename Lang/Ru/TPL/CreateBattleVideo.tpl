        ...
        <div class="DivDualBlock">                
            ...
            <div class="BtColInputLink">                                
                <form id="data1">
                    ...
                    <input type="text" class="FileNamwBtlUp1" id="FileNamwBtlUp1" placeholder="Ссылка на видео 1" onchange="UpdateLinkVideo(1)">                                                                                    
        ...
        <div class="DivDualBlockR">                       
            ...
            <div class="BtColInputLink">
                <form id="data2">
                    ...
                    <input type="text" class="FileNamwBtlUp2" id="FileNamwBtlUp2" placeholder="Ссылка на видео 2" onchange="UpdateLinkVideo(2)">                      
